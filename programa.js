...
const mates = [
    ...
    {nombre: "Mate Batman",precio: 1700},
...
for(const pps of pp){
    ...
    carta.innerHTML=`
        <div class="card-body">
            <h5 class="card-title">${pps.nombre}</h5>
            <p class="card-text">${pps.precio}</p>
...
for(const mate of mates){
    ...
    carta2.className="card col-md-4";
    carta2.innerHTML=`
        <div class="card-body">
            <h5 class="card-title">${mate.nombre}</h5>
            <p class="card-text">${mate.precio}</p>
            <a href="#" class="btn btn-primary">COMPRAR</a>
        </div>
    `;
    cartas2.append(carta2);
}
